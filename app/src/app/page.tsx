...
function SocialIcon({ src, w, h, href }: { src: string; w: number; h: number; href?: string }) {
  ...
  const inner = (
    <>
      ...
      <img alt="" src={src} style={{ width: w, height: h, position: "relative", zIndex: 1, opacity: hovered ? 1 : 0.5, transition: "opacity 0.3s ease" }} />
    </>
  );
  if (href) return (
  ...
  return createPortal(
    <div
      style={{
        ...
        width: isPointer ? 22 : 10,
        height: isPointer ? 22 : 10,
        borderRadius: '50%',
