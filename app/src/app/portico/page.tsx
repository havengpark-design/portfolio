  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="w-[60%] mx-auto pt-[120px] pb-[120px]">
        ...
        {/* Hero visual */}
        <FadeIn delay={80} className="w-full rounded-[32px] overflow-hidden mb-[96px]" style={{ aspectRatio: "16/9", background: "#F9E0D0" }}>
        ...
        <FadeIn className="mb-[80px]">
          ...
          <div className="flex flex-col gap-[8px]">
            {[
              { title: "Define the Ideal Integrated Student Experience", desc: "Deliver a clear, opinionated vision for how the student experience should be structured — ensuring tools, features, and touchpoints work together as one unified journey from first login to academic completion." },
              { title: "Deliver Tactical Design Guidance for Q4", desc: "Provide actionable design guidance to unify specific areas of the student experience so that a new student starting a program with Portico in 2026 has a seamless single-app experience." },
            ].map((item, i) => (
              <div key={item.title} className="flex gap-[20px] rounded-[10px] px-[14px] py-[12px] -mx-[14px] hover:bg-[#F0FAF8] transition-colors duration-200 cursor-default">
                <span className="text-[#1A9E89] text-[13px] shrink-0 mt-[3px]">0{i + 1}</span>
                <div>
        ...
        <FadeIn className="mb-[80px]">
          ...
          <div className="flex flex-col gap-[8px]">
            {process.map((step) => (
              <div key={step.phase} className="flex gap-[20px] rounded-[10px] px-[14px] py-[12px] -mx-[14px] hover:bg-[#F0FAF8] transition-colors duration-200 cursor-default">
        ...
        <FadeIn className="mb-[96px]">
          ...
          <div className="flex gap-[40px] items-start mb-[64px]">
            <div className="transition-all duration-300 hover:-translate-y-[2px] shrink-0">
              <LightboxImage src="/Design/portico/home.png" alt="Portico Home Screen" className="max-h-[80vh] w-auto block rounded-[20px] transition-shadow duration-300 hover:shadow-[0_12px_48px_rgba(0,0,0,0.12)]" />
            </div>
          ...
          <div className="flex gap-[40px]">
            <div className="flex-1 flex gap-[24px] items-start">
              <div className="transition-all duration-300 hover:-translate-y-[2px] shrink-0">
                <LightboxImage src="/Design/portico/Skills.png" alt="Portico Skills Screen" className="max-h-[75vh] w-auto block rounded-[20px] transition-shadow duration-300 hover:shadow-[0_12px_48px_rgba(0,0,0,0.12)]" />
              </div>
              <div className="flex gap-[20px] pt-[4px]">
            ...
            <div className="flex-1 flex gap-[24px] items-start">
              <div className="transition-all duration-300 hover:-translate-y-[2px] shrink-0">
                <LightboxImage src="/Design/portico/course.png" alt="Portico Course Screen" className="max-h-[75vh] w-auto block rounded-[20px] transition-shadow duration-300 hover:shadow-[0_12px_48px_rgba(0,0,0,0.12)]" />
              </div>
              <div className="flex gap-[20px] pt-[4px]">
