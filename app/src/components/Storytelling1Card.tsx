...
export default function Storytelling1Card() {
  return (
    <Link
      href="/storytelling/1"
      ...
      onMouseEnter={() => {
        ...
        if (main) { main.style.transition = "background 0.4s ease"; main.style.background = "rgb(252, 243, 243)"; }
      }}
      onMouseLeave={() => {
        const main = document.querySelector("main") as HTMLElement | null;
    ...
    >
      ...
      <img
        src="/Storytelling/Storytelling1.png"
        alt="Storytelling"
